...
input_file = 'Numerical_results/herm_dist_loc.dat'

# getting the title for the files and the plot
file_tit = 'herm_dist_loc'
...
set encoding utf8
set title 'Distribution of the spacings: Hermitian, local'
...
# getting the name of the input file from the settings.txt file
input_file = 'Numerical_results/diag_dist_loc.dat'

# getting the title for the files and the plot
file_tit = 'diag_dist_loc'
...
set terminal pdfcairo enhanced color dashed font "TeX Gyre Pagella, 20" rounded size 16 cm, 9.8 cm
set encoding utf8
set title 'Distribution of the spacings: Diagonal, local'
